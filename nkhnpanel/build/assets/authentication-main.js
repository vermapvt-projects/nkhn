(function () {
    ...
    if (localStorage.ynexrtl) {
        ...
        document.querySelector("#style")?.setAttribute("href", "https://laravelui.spruko.com/ynex/build/assets/libs/bootstrap/css/bootstrap.rtl.min.css");
    }
...
function ltrFn() {
    ...
    if(!document.querySelector("#style").href.includes('bootstrap.min.css')){
        document.querySelector("#style")?.setAttribute("href", "https://laravelui.spruko.com/ynex/build/assets/libs/bootstrap/css/bootstrap.min.css");
    }
