            ...
            <aside class="app-sidebar sticky" id="sidebar">
                ...
                <div class="main-sidebar-header">
                    <a href="index.html" class="header-logo">
                        <img src="../assets/logo/Frame 269.png" alt="logo" class="desktop-logo">
                        <img src="build/assets/images/brand-logos/toggle-logo.png" alt="logo" class="toggle-logo">
                        <img src="../assets/logo/Frame 269.png" alt="logo" class="desktop-dark">
                ...
                <div class="main-sidebar" id="sidebar-scroll">
                    ...
                    <nav class="main-menu-container nav nav-pills flex-column sub-open">
                        ...
                        <ul class="main-menu">
                            ...
                            <!-- Start::slide__category -->
                            <li class="slide__category"><span class="category-name">Clients</span></li>
                            <!-- End::slide__category -->
                            ...
                            <li class="slide has-sub">
                                <a href="javascript:void(0);" class="side-menu__item">
                                    ...
                                    <span class="side-menu__label">Clients<span class="badge bg-secondary-transparent ms-2"></span></span>
                                    <i class="fe fe-chevron-right side-menu__angle"></i>
                                </a>
                            ...
                            <ul class="slide-menu child1">
                                    ...
                                    <li class="slide">
                                        <a href="all_clients.php" class="side-menu__item">All leads</a>
                                    </li>
                                </ul>
                            </li>
